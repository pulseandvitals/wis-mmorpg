...
class MonsterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $monsters = [
            [
                'name' => 'Ember Wyrm',
                'description' => 'A fierce dragon that breathes flames.',
                'monster_type' => 'beast',
                'attack' => json_encode(['name' => 'Flame Lunge', 'damage' => 50]),
                'gif_path' => URL::to('gifs/ember_wyrm.gif'),
            ],
            [
                'name' => 'Stone Goliath',
                'description' => 'A massive stone golem with incredible strength.',
